      ...
      <div style={containerStyle}>
        ...
        <div>
          ...
          <AccordionItem title="How To / About">
            Type something in to see candidate anagrams of different lengths.
            You can also add a custom word if the one you want isn't present.
            There are many word lists to choose from right now, as I find which
            ones are not bringing anything of value, I'll remove them.
            <br />
            The 10k, 20k, and 30k word lists seem possibly lower quality, I
            think they were collected with scraping? Source{" "}
            ...
            The lists include information about "keys" rather than "words"
            because it searches for keys that correspond to sets of words rather
